...
def main(input_file, verbose=True, n_jobs=-1):
    ...
    best_model, val_acc, val_roc_auc = train_random_forest(X_train_scaled, X_val_scaled, y_train, y_val, verbose=verbose, n_jobs=n_jobs)
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        print("Usage: python train_random_forest.py <input_csv_file>")
        sys.exit(1)
